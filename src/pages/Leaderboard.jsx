...
const Leaderboard = () => {
        ...
        <>
          <div className={styles.topdetails}>
            ...
            <div className={styles.toprank}>
              ...
              {/* <img className={styles.icon} width="41" height="1" src="https://img.icons8.com/external-detailed-filled-line-rakhmat-setiawan/61/external-1st-winner-seo-website-detailed-filled-line-rakhmat-setiawan.png" alt="external-1st-winner-seo-website-detailed-filled-line-rakhmat-setiawan" /> */}
              <div className={styles.number}>1 <p className={styles.tag}>st</p> </div>
              {/* <img className={styles.icon} width="35" height="30" src="https://img.icons8.com/external-xnimrodx-lineal-color-xnimrodx/64/external-crown-advertising-xnimrodx-lineal-color-xnimrodx.png" alt="external-crown-advertising-xnimrodx-lineal-color-xnimrodx" /> */}
            </div>
      ...
      teamData[section]?.filter(member => member.name === memberName).map((member, index) => (
        <>
          <div className={styles.topdetails}>
            ...
            <p className={styles.toprank}>
              {/* <img width="680" height="680" src="https://img.icons8.com/external-flat-icons-vectorslab/68/external-2nd-Position-Badge-badges-and-awards-flat-icons-vectorslab.png" alt="external-2nd-Position-Badge-badges-and-awards-flat-icons-vectorslab" /> */}
        ...
        <>
          <div className={styles.topdetails}>
            ...
            <p className={styles.number}>3 <p className={styles.tag}>rd</p></p>
              {/* <img className={styles.icon} width="34" height="34" src="https://img.icons8.com/arcade/64/third-place-ribbon.png" alt="third-place-ribbon" /> */}
              {/* <img width="100" height="100" src="https://img.icons8.com/plasticine/100/000000/gold-medal.png" alt="gold-medal" /> */}
            </p>
            <p className={styles.topname}>{member.name}</p>
            {/* <p className={styles.toprankdetail}>{Rank}</p> */}
  ...
  return (
    <div className={styles.leaderboard_section}>
      ...
      <p className={styles.performer}>Top Performers</p>
